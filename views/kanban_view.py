...
class KanbanView(ctk.CTkFrame):
    def __init__(self, parent, data_manager, popup_manager):
        ...
        # 칸반 컬럼 정의 (Sales Manager 프로세스 반영)
        self.columns = {
            ...
            "납품/입금": {"color": COLORS["success"], "bg": COLORS["bg_dark"]}, # 납품완료/입금대기 등 포함
    ...
    def create_widgets(self):
        ...
        for i, (status, style) in enumerate(self.columns.items()):
            ...
            col_container.status_tag = status # 드롭 타겟 식별용
    ...
    def refresh_data(self):
        ...
        for idx, row in df.iterrows():
            ...
            if target_col and target_col in self.column_frames:
                self.create_card(target_col, row)
    ...
    def stop_drag(self, event):
        ...
        if self.drag_started:
            ...
            if target_col and target_col != start_col:
                ...
                if target_col == "납품/입금": new_status = "납품대기" # 기본값
